public class Laborator2{
    ...
    public static class Problem{
        ...
        public Problem(String numeSol, SourceType tipSol, int cantitateSol, String numeDest, int cerereDest, int costProblema){
    ...
    public static void main(String[] args){
        //instantam solutiile din problema data in exemplu
            Solution sol1=new Solution("S1",SourceType.FACTORY,10);
            Solution sol2=new Solution("S2",SourceType.WAREHOUSE,35);
            Solution sol3=new Solution("S3",SourceType.WAREHOUSE,25);
